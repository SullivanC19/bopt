...
bool NodeDataManager_Trie::updateData(Node *best, Error upperBound, Attribute attribute, Node *left, Node *right, float splitPenalty, Itemset itemset) {
